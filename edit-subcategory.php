...
<?php } ?>
			...
			<form action="subcategory.php"class="form-horizontal row-fluid" name="Category" method="post" >
<?php
$id=intval($_GET['id']);
$query=mysqli_query($con,"select category.catid,category.categoryName,subcategory.subcategory from subcategory join category on category.catid=subcategory.categoryid where subcategory.id='$id'");
