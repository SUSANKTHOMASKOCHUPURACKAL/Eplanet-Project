...
<?php $query=mysqli_query($con,"select products.*,category.categoryName,subcategory.subcategory from products join category on category.catid=products.category join subcategory on subcategory.id=products.subCategory");
$cnt=1;
